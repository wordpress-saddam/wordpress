...
<!--                             <p class="sub-title h4-sub-title"><?php echo esc_html( $settings['section_sub_title'] ); ?></p> -->
                            <h2 class="title split-text"><?php echo wp_kses_post( $settings['section_main_title'] ); ?></h2>
                        </div>
                    </div>
                </div>
            </div>
