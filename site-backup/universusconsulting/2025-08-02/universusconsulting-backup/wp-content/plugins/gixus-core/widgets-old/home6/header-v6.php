...
class Elementor_Gixus_Header_v6_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'gixus_header_v6';
    }

    public function get_title() {
        return __( 'Gixus Header v6', 'gixus' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'button_text',
            [
                'label' => __( 'Button Text', 'gixus' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __( 'Get consultant', 'gixus' ),
            ]
        );
                ...
                <div class="container d-flex justify-content-between align-items-center">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="<?php echo esc_url( home_url() ); ?>">
                            <img src="<?php echo esc_url( $settings['logo1']['url'] ); ?>" class="logo logo-display" alt="Logo">
                            <img src="<?php echo esc_url( $settings['logo']['url'] ); ?>" class="logo logo-scrolled" alt="Logo">
                        </a>
                    </div>
                                ...
                                <?php if ( ! empty( $settings['button_text'] ) ) : ?>
                                    <li class="button dark">
                                        <a href="<?php echo esc_url( $settings['button_link']['url'] ); ?>">
                                            <?php echo esc_html( $settings['button_text'] ); ?> <i class="fas fa-long-arrow-right"></i>
                                        </a>
                                    </li>
                                <?php endif; ?>
                            </ul>
