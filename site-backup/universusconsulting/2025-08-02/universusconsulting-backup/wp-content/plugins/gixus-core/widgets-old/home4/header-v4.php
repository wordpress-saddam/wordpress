...
class Elementor_Home_Four_Header_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'home_four_header';
    }

    public function get_title() {
        return __('Home Four Header', 'gixus-core');
    }
    ...
    // Menu Type Selector
		...
		$this->add_control(
            'menu_type1',
            [
                'label' => __( 'Menu Color', 'gixus' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'default' => __( 'White Mode', 'gixus' ),
                    'dark' => __( 'Dark Mode', 'gixus' ),
                ],
                'default' => 'default',
            ]
        );
    ...
    $this->add_control(
        'logo_image',
        [
            'label' => __('Logo', 'gixus-core'),
            'type' => \Elementor\Controls_Manager::MEDIA,
            'default' => [
                'url' => get_template_directory_uri() . '/assets/img/logo-2-light.png',
            ],
        ]
    );
    ...
    $this->add_control(
        'scrolled_logo_image',
        [
            'label' => __('Scrolled Logo', 'gixus-core'),
            'type' => \Elementor\Controls_Manager::MEDIA,
            'default' => [
    ...
    $this->add_control(
        'tracking_link',
        [
            'label' => __('Tracking Link', 'gixus-core'),
	...
	$this->add_control(
        ...
        [
            ...
            'default' => [
                'value' => 'fa fa-truck', // Default icon (Font Awesome truck)
                'library' => 'fa', // Icon library (Font Awesome)
            ],
        ]
    );
    ...
    $this->add_control(
        'tracking_text',
        [
            'label' => __('Tracking Text', 'gixus-core'),
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => __('Track your order', 'gixus-core'),
        ]
    );
    ...
    $this->add_control(
        'sidebar_logo',
        [
            'label' => __('Sidebar Logo', 'gixus-core'),
            'type' => \Elementor\Controls_Manager::MEDIA,
            'default' => [
                'url' => get_template_directory_uri() . '/assets/img/logo-2-light.png',
            ],
    ...
    $this->add_control(
        'sidebar_description',
        [
            'label' => __('Sidebar Description', 'gixus-core'),
            'type' => \Elementor\Controls_Manager::TEXTAREA,
            'default' => __('Arrived compass prepare an on as. Reasonable particular on my it in sympathize. Size now easy eat hand how. Unwilling he departure elsewhere dejection at. Heart large seems may purse means few blind.', 'gixus-core'),
        ]
    );
    
    // Sidebar Contact Repeater
    $repeater1 = new \Elementor\Repeater();
    $repeater1->add_control(
        'sidebar_contact_list_title',
        [
            'label' => __('Contact List Title', 'gixus-core'),
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => 'ADDRESS',
        ]
    );
    ...
    $repeater1->add_control(
        'sidebar_contact_list_text',
        [
            'label' => __('Contact List Text', 'gixus-core'),
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => 'California, TX 70240',
        ]
    );
    ...
    $this->add_control(
        'sidebar_contact',
        [
            'label' => __('Sidebar Contact', 'gixus-core'),
            'type' => \Elementor\Controls_Manager::REPEATER,
            'fields' => $repeater1->get_controls(),
            'default' => [
                [
                    'sidebar_contact_list_title' => __( 'ADDRESS', 'gixus-core' ),
                    'sidebar_contact_list_text' => __( 'California, TX 70240', 'gixus-core' ),
                ],
                [
                    'sidebar_contact_list_title' => __( 'EMAIL', 'gixus-core' ),
                    'sidebar_contact_list_text' => __( 'wordpressriver@gmail.com', 'gixus-core' ),
                ],
                [
                    'sidebar_contact_list_title' => __( 'CONTACT', 'gixus-core' ),
                    'sidebar_contact_list_text' => __( '+44-20-7328-449', 'gixus-core' ),
                ],
            ],
            'title_field' => '{{{ sidebar_contact_list_title }}}',
        ]
    );
    ...
    $this->add_control(
        'newsletter_title',
        [
            'label' => __('Newsletter Title', 'gixus-core'),
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => __('Get Subscribed!', 'gixus-core'),
        ]
    );
    ...
    $this->add_control(
        ...
        [
            ...
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => '[contact-form-7 id="957a7eb" title="Header Four Form"]',
            'placeholder' => __('[contact-form-7 id="957a7eb" title="Header Four Form"]', 'gixus-core'),
        ]
    );
    ...
    $this->add_control(
        ...
        [
            ...
            'default' => [
                [
                    'social_icon' => __('fab fa-facebook-f', 'gixus-core'),
                    'social_link' => ['url' => '#'],
                ],
                [
                    'social_icon' => __('fab fa-twitter', 'gixus-core'),
                    'social_link' => ['url' => '#'],
                ],
                [
                    'social_icon' => __('fab fa-linkedin-in', 'gixus-core'),
                    'social_link' => ['url' => '#'],
                ],
                [
                    'social_icon' => __('fab fa-behance', 'gixus-core'),
                    'social_link' => ['url' => '#'],
                ],
            ],
    ...
    <header>
        <!-- Start Navigation -->
		<?php if ( 'default' === $settings['menu_type1'] ) : ?>
        <nav class="navbar mobile-sidenav inc-border navbar-full-width navbar-sticky navbar-default validnavs navbar-fixed white no-background">
		<?php else: ?>
			<nav class="navbar mobile-sidenav inc-border navbar-full-width navbar-sticky navbar-default validnavs navbar-fixed dark no-background">
		<?php endif; ?>
                ...
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navbar-menu">
                        ...
                        <a class="navbar-brand" href="<?php echo esc_url(home_url('/')); ?>">
                            <img src="<?php echo esc_url($settings['logo_image']['url']); ?>" class="logo logo-display" alt="Logo">
                            <img src="<?php echo esc_url($settings['scrolled_logo_image']['url']); ?>" class="logo logo-scrolled" alt="Logo">
                        </a>
                    </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                            ...
                            <ul class="nav navbar-nav navbar-center" data-in="fadeInDown" data-out="fadeOutUp">
                                <li class="dropdown megamenu-fw">
                                    ...
                                    <ul class="dropdown-menu megamenu-content" role="menu">
                                                ...
                                                <?php foreach ( $settings['megamenu_items'] as $item ) : ?>
                                                    <div class="col-item">
                                                        <div class="menu-thumb">
                                                            <img src="<?php echo esc_url( $item['image']['url'] ); ?>" alt="Image Not Found">
                                                            <div class="overlay">
                                        ...
                                        <img src="<?php echo esc_url( $settings['megamenu_intro_image']['url'] ); ?>" alt="Image Not Found">
                    ...
                    <div class="attr-right">
                        <div class="attr-nav">
                            <ul>
                                <li class="tracing">
                                    <a href="<?php echo esc_url($settings['tracking_link']['url']); ?>">
                                        <div class="icon"><i class="<?php echo esc_attr($settings['truck_icon']['value']); ?>"></i></div>
                                        <div class="info">
                                            <h5><?php echo esc_html($settings['tracking_text']); ?></h5>
                                        </div>
                                    </a>
                                </li>
                                <li class="side-menu">
                    ...
                    <div class="side">
                        ...
                        <div class="widget">
                            <div class="logo">
                                <img src="<?php echo esc_url($settings['sidebar_logo']['url']); ?>" alt="Logo">
                            </div>
                            <p><?php echo esc_html($settings['sidebar_description']); ?></p>
                        </div>
                        <div class="widget address">
                            <ul>
                                <?php foreach ( $settings['sidebar_contact'] as $sidebar_contact1 ) : ?>
                                <li><div class="content"><p><?php echo esc_html($sidebar_contact1['sidebar_contact_list_text']); ?></p><strong><?php echo esc_html($sidebar_contact1['sidebar_contact_list_title']); ?></strong></div></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                        <div class="widget newsletter">
                            <h4 class="title"><?php echo esc_html($settings['newsletter_title']); ?></h4>
                            <?php echo do_shortcode( $settings['contact_form_shortcode'] ); ?>
                        </div>
                        <div class="widget social">
                            <ul class="link">
                                <?php foreach ( $settings['social_links'] as $link ) : ?>
                                    <li><a href="<?php echo esc_url($link['social_link']['url']); ?>"><i class="<?php echo esc_attr($link['social_icon']); ?>"></i></a></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                    </div>
