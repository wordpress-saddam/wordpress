...
class Elementor_Home1_Faq_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Home One FAQ Widget', 'gixus-core' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'faq-style-one-area chooseus-style-two-area', 'gixus-core' ),
            ]
        );
