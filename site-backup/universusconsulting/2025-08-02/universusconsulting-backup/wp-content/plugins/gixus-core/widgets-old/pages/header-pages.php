...
class Elementor_Gixus_Header_Pages_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'gixus_header_pages';
    }

    public function get_title() {
        return __( 'Gixus Header Pages', 'gixus' );
    }
    ...
    <header>
        <!-- Start Navigation -->
        <nav class="navbar mobile-sidenav navbar-common navbar-sticky navbar-default validnavs dark">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="<?php echo esc_url( home_url() ); ?>">
                            <img src="<?php echo esc_url( $settings['logo']['url'] ); ?>" class="logo" alt="Logo">
                        </a>
                    </div>
