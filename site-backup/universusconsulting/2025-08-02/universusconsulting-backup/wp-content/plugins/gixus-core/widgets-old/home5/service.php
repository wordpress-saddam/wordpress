    ...
    protected function render() {
        ...
        <div class="services-style-two-area default-padding-top bg-gray">
            <div class="services-style-two-thumb">
                <img src="<?php echo esc_url( $settings['service_thumb_image']['url'] ); ?>" alt="Image Not Found">
                <img src="<?php echo esc_url( $settings['shape_image']['url'] ); ?>" alt="Image Not Found">
            </div>
            <div class="shape">
                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/shape/18.png' ); ?>" alt="Image Not Found">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
