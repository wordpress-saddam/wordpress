                                        ...
                                        foreach ( $settings['testimonial_items'] as $item ) :
                                            ...
                                            <div class="swiper-slide">
                                                <div class="testimonial-style-three">
                                                    <div class="thumb">
                                                        <img src="<?php echo esc_url( $item['testimonial_image']['url'] ); ?>" alt="Universus Consulting Service">
                                                        <div class="icon">
                                                            <img src="<?php echo esc_url( $settings['quote']['url'] ); ?>" alt="Universus Consulting Service">
                                                        </div>
                                                    </div>
                                                    <div class="item">
                                                        <div class="content">
