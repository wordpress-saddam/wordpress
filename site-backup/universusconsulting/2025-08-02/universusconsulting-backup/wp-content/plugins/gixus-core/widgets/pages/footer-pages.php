    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    'url' => 'https://www.universusconsulting.com/wp-content/uploads/2024/10/Universus-Consulting-logo-400x130-1.png',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Empowering entrepreneurs to launch and grow businesses in Dubai, UAE, with expert setup in all types of economic zones, visa services, and compliance services.', 'gixus' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    ['contact_label' => 'Our Location', 'contact_value' => 'IFZA Business Park, Building A1, Dubai Silicon Oasis, Dubai UAE, PO Box: 342001', 'contact_link' => '#'],
                ],
...
news and special offers.', 'gixus' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
    [
        'service_title3' => __( 'Made with ❤️ by Seowizzz', 'gixus-core' ),
        'service_link3'  => [ 'url' => 'https://www.seowizzz.com' ]
    ],
    [
    ...
    [
        ...
        'default' => [
            [
                ...
                'link' => [
                    'url' => 'https://www.linkedin.com/company/universus-consulting-fzco/',
                ],
            ],
			[
                'icon' => [
...
// 		echo "<pre>"; print_r($settings); echo "</pre>"; die(__FILE__);
		$settings['enable_social'] = 'yes';
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 footer-item pr-30 pr-md-15 pr-xs-15">
                        <div class="f-item address">
                            <img src="<?php echo esc_url( $settings['logo']['url'] ); ?>" alt="Universus Consulting Service" style="width:250px;height:auto;">
   <p>
                        ...
                        <div class="col-lg-2 col-md-6 footer-item">
                            <div class="f-item link">
                                <h2 class="widget-title h4-to-h2"><?php echo esc_html( $settings['link_one_text'] ); ?></h2>
								<?php
								wp_nav_menu( array(
...
<!--                                 <ul>
                        ...
                        <div class="col-lg-2 col-md-6 footer-item">
                            <div class="f-item link">
                                <h2 class="widget-title h4-to-h2"><?php echo esc_html( $settings['link_two_text'] ); ?></h2>
								<?php
								wp_nav_menu( array(
        ...
        <div class="col-lg-4 col-md-6 footer-item">
			<?php { ?>
                        ...
                        <?php endif; ?>
							<h5>UAE</h5>
							<p>
								IFZA Business Park, <br>Building A1, <br>Dubai Silicon Oasis, <br>Dubai UAE. <br>PO Box: 342001 <br> Contact no: +971 55 539 7229
							</p> <hr style="color: #000; border-color: #000; margin-top: -10px; padding-top: 10px; width: 60%;">
							<h5>India</h5>
							<p>
								India Accelerator, <br>MGF Metropolis Mall, <br>Gurugram, Haryana, India <br>Pin - 122001
<br>Contact no: +91 9999 105 777
							</p>
...
<!-- 							 <?php if(!empty($settings['contact_form_des'])): ?>
            ...
            <?php endif; ?>
                    ...
                    <div class="col-lg-6" style="color:#000;">		
                       <?php if ('yes' === $settings['enable_dynamic']): ?>
						...
						<?php endif; ?>
						<?php echo __( '&copy; Copyright 2025. All Rights Reserved by <a href="https://www.universusconsulting.com/" style="color:#000;">Universus Consulting FZCO</a>', 'gixus' ); ?>
                    </div>
                     <div class="col-lg-6 text-end">
                        ...
                        <?php foreach ( $settings['link_three'] as $service3 ) : ?>
                            <li>
                                <?php
        // If this is the "Made with love by SEOWizzz" text
        if ( strpos( $service3['service_title3'], 'SEOWizzz' ) !== false ) {
            // Split at "SEOWizzz"
            $parts = explode('SEOWizzz', $service3['service_title3']);
            echo esc_html($parts[0]); // "Made with love by "
            ?>
        ...
        <?php
            ...
            // For all other items, show as normal links
        ?>
            <a href="<?php echo esc_url($service3['service_link3']['url']); ?>">
