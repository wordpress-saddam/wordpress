...
class Elementor_Home2_About_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Home Two About', 'gixus-core' );
    }
...
<!--                             <h4 class="sub-title"><?php echo esc_html( $settings['about_subtitle'] ); ?></h4> -->
...
<!--                             <div class="info-grid mt-50">
                                <div class="left-info wow fadeInLeft" data-wow-delay="200ms">
                                    <div class="fun-fact-card-two">
                                        <h4 class="sub-title"><?php echo esc_html( $settings['expertise_title'] ); ?></h4>
                    ...
                    <div class="col-lg-5 offset-lg-1">
                        <div class="thumb-style-two wow fadeInUp">
                            <img src="<?php echo esc_url( $settings['about_image']['url'] ); ?>" alt="Universus Consulting Service">
                        </div>
                    </div>
                </div>
            </div>
