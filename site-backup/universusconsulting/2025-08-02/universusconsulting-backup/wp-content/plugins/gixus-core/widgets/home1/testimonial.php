                ...
                <div class="row align-center">
                    <div class="col-xl-5 pr-80 pr-md-15 pr-xs-15">
                        <div class="testimonial-style-one-thumb">
                            <img src="<?php echo esc_url($settings['image']['url']); ?>" alt="Universus Consulting Testiminial">
                            <div class="shape">
                                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/shape/16.png'); ?>" alt="Universus Consulting Testiminial">
                                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/shape/17.png'); ?>" alt="Universus Consulting Testiminial">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-7">
