...
class Elementor_Gixus_Header_Widget extends \Elementor\Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'layout1' => __( 'Layout 1 Button Light', 'gixus-core' ),
                    'layout2' => __( 'Layout 2 Button Dark', 'gixus-core' ),
                ],
                'default' => 'layout1',
            ]
        );
                            ...
                            <ul class="nav navbar-nav navbar-center" data-in="fadeInDown" data-out="fadeOutUp">
                                <li class="dropdown megamenu-fw">
                                    ...
                                    <ul class="dropdown-menu megamenu-content" role="menu">
                                                ...
                                                <?php foreach ( $settings['megamenu_items'] as $item ) : ?>
                                                    <div class="col-item">
                                                        <div class="menu-thumb">
                                                            <img src="<?php echo esc_url( $item['image']['url'] ); ?>" alt="Universus Consulting">
                                                            <div class="overlay">
                                        ...
                                        <img src="<?php echo esc_url( $settings['megamenu_intro_image']['url'] ); ?>" alt="Universus Consulting">
