...
class Elementor_pages_contact_Section_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'pages_pages_contact_section';
    }

    public function get_title() {
        return __( 'Pages Contact Section', 'gixus-core' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'pages_contact_form_shortcode',
            [
                'label' => __( 'Contact Form 7 Shortcode', 'gixus-core' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => '[contact-form-7 id="dc3c1d5" title="Contact Page Form"]', // Replace with your form ID
            ]
        );
    ...
    protected function render() {
        ...
        <div class="contact-style-one-area overflow-hidden default-padding">
            <div class="contact-shape">
                ...
                <img src="<?php echo esc_url( $settings['shape_background']['url'] ); ?>" alt="Universus Consulting Service">
                <?php endif; ?>
            </div>
            <div class="container">
                <div class="row align-center">
                    ...
                    <div class="contact-stye-one col-lg-2 mb-md-50 mb-xs-40">
						<?php if(false): ?>
                        <div class="contact-style-one-info">
                            <h4 class="sub-title"><?php echo esc_html( $settings['pages_contact_sub_title'] ); ?></h4>
                            <h2><?php echo esc_html( $settings['pages_contact_title'] ); ?></h2>
                            <p><?php echo esc_html( $settings['pages_contact_description'] ); ?></p>
                            <ul>
                                <?php foreach ( $settings['pages_contact_methods'] as $index => $method ) : ?>
                                    <li class="wow fadeInUp" data-wow-delay="<?php echo esc_attr( ( $index * 250 ) . 'ms' ); ?>">
                                        <div class="icon">
                                            <i class="<?php echo esc_attr( $method['method_icon']['value'] ); ?>"></i>
                                        </div>
                                        <div class="content">
                                            <h5 class="title"><?php echo esc_html( $method['method_title'] ); ?></h5>
                                            <a href="<?php echo esc_url( $method['method_link']['url'] ); ?>"><?php echo $method['method_content']; ?></a>
                                        </div>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                    ...
                    <div class="contact-stye-one col-lg-8 pl-60 pl-md-15 pl-xs-15">
                        <div class="contact-form-style-one">
                            ...
                            <?php echo do_shortcode( $settings['pages_contact_form_shortcode'] ); ?>
                        </div>
                    </div>
                </div>
            </div>
