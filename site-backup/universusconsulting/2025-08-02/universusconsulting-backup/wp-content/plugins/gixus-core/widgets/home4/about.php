                ...
                <div class="row align-center">
                    <div class="col-xl-4 col-lg-6">
                        <div class="thumb-style-four">
                            ...
                            <img src="<?php echo esc_url($settings['image_one']['url']); ?>" alt="Universus Consulting Service">
                            <?php endif; ?>
                            <?php if(!empty($settings['image_two']['url'])): ?>
                            <img src="<?php echo esc_url($settings['image_two']['url']); ?>" alt="Universus Consulting Service">
                            <?php endif; ?>
                    ...
                    <div class="col-xl-3">
                        <div class="address-card wow fadeInRight">
                             <div class="thumb">
                            <img src="<?php echo esc_url($settings['image_three']['url']); ?>" alt="Universus Consulting Service">
                        </div>
                            <div class="info">
