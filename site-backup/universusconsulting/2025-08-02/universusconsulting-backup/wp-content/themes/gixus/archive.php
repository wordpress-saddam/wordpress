    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <h1><?php
            if ( is_day() ) :
                esc_html_e( 'Daily Archives: ', 'gixus' );
            
            elseif ( is_month() ) :
                esc_html_e( 'Monthly Archives: ', 'gixus' );
            
            
            elseif ( is_year() ) :
                esc_html_e( 'Yearly Archives: ', 'gixus' );
...
?></h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?php esc_html_e( 'Archives', 'gixus' )?></li>
                    </ol>
                </nav>
            </div>
        </div>
