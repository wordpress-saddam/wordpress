            ...
            <div class="blog-item-box">
                <div class="row">
                         ...
                         <?php 
                            ...
                            $selected_categories = $gixus_options['category_selection_3'];  // Redux option for categories
                            $number_of_posts = $gixus_options['number_of_posts_3'];  // Redux option for number of posts
                    ...
                    <div class="col-xl-4 col-md-6 col-lg-6 mb-50">
                        <div class="home-blog-style-one-item animate" data-animate="fadeInUp" data-delay="100ms">
                            ...
                            <?php endif; ?>
                                ...
                                <li><a href="<?php $cat = get_the_category(); echo esc_url( get_category_link( $cat[2]->term_id ) ); ?>"><?php echo esc_html( $cat[2]->name ); ?></a></li>
                                <li><?php echo get_the_modified_date(); ?></li>
                            </ul>
                     </div>
                            <div class="content">
                                <div class="info">
                                    <h2 class="blog-title h4-to-h2">
